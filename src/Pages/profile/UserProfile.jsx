...
import DualAxisChart from "../../Component/Chartjs/DualAxisChart";
...
const UserProfile = () => {
  ...
  // New state for tracking trends type
  ...
  const fetchCaloriesData = async () => {
    ...
    try {
      ...
      const response = await apiClient.post(apiUrl, { monthFilter: effectiveMonthOptions[safeSelectedIndex] });
  ...
  useEffect(() => {
    if (effectiveMonthOptions.length > 0) {
    fetchCaloriesData();
    }
  }, [selectedRangeIndex, monthFilterOptions]);
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {patientData && patientData.sms_status === "FAILED" && patientSlug ? (
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="rounded-2xl shadow-lg py-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {trendsType === "vitals" && (
                      <div className="">
                        ...
                        >
                          <SelectTrigger className="w-24 bg-white border-gray-200 focus:ring-1 focus:ring-gray-500 focus:border-gray-500">
                            <SelectValue placeholder="Select vital to display" />
                          </SelectTrigger>
                          <SelectContent className="bg-white border-gray-200 text-sm">
                        ...
                        {/* <select
                          ...
                          className="p-2 rounded-lg !border-gray-200 disabled:opacity-50 transition-colors duration-200 outline-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
                          aria-label="Select vital to display"
                        >
                          <option value="All">{t("userProfile.all", "All")}</option>
                          <option value="Blood Pressure">{t("userProfile.bloodPressure", "Blood Pressure")}</option>
                          <option value="HRV">{t("userProfile.hrv", "HRV")}</option>
                          <option value="Heart Rate">{t("userProfile.heartRate", "Heart Rate")}</option>
                          <option value="Breathing Rate">{t("userProfile.breathingRate", "Breathing Rate")}</option>
                        </select> */}
                      </div>
                    )}
                    ...
                    {trendsType === "calories" && (
                      <div className="">
                        ...
                        >
                          <SelectTrigger className="w-24 bg-white border-gray-200 focus:ring-1 focus:ring-gray-500 focus:border-gray-500">
                            <SelectValue placeholder="Select nutrition metric to display" />
                          </SelectTrigger>
                          <SelectContent className="bg-white border-gray-200 text-sm">
                        ...
                        {/* <select
                          ...
                          onChange={(e) => setSelectedChartVital(e.target.value)}
                          className="p-2 rounded-lg !border-gray-200 disabled:opacity-50 transition-colors duration-200 outline-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
                          aria-label="Select nutrition metric to display"
                        >
                ...
                {vitalsLoading ? (
                      ...
                      if (filteredCaloriesData.length === 0) {
                        return (
                          <div className="flex flex-col items-center justify-center py-16 text-gray-400">
                            <p className="text-xl font-medium mb-2">No calories data for selected month</p>
                            <p className="text-sm text-gray-500">Try selecting a different month range</p>
                          </div>
                        );
                      }
                  ...
                  <div className="flex flex-col items-center justify-center py-16">
                    <Loader2 className="w-8 h-8 animate-spin text-black mb-4" />
                    <p className="text-gray-500">Loading calories data...</p>
                  </div>
                ) : (
                  <div className="flex flex-col items-center justify-center py-16 text-gray-400">
                                  ...
                                  <tr key={item.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 border-x-none">
                                      <div className="text-sm text-gray-900">
                                        ...
                                        <span className="ml-2 px-2 py-1 rounded font-semibold text-gray-500">
                                          {item.calories}
                                        </span>
                                      </div>
                                    </td>
